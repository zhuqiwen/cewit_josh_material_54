...
@section('header_styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/vendors/bootstrap-slider/css/bootstrap-slider.css') }}"/>
                        ...
                        <div class="panel panel-primary filterable">
                            ...
                            <div class="row filter">
                                <div class="col-md-4 col-md-offset-4">
                                    <label class="control-label lab_pad">ID Range :</label>
                                    <div> <b class="margin_right15">{{$min_id}}</b>
                                        <input id="id_range" type="text" data-slider-id='id_range' class="slider" data-slider-handle="square" value="" data-slider-min="{{$min_id}}" data-slider-max="{{$max_id}}" data-slider-step="1" data-slider-value="[{{$min_id}},{{$max_id}}]"/> <b class="m-l-15">@if(!empty($max_count)){{$max_id}} @else 10 @endif</b>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-primary filterable">
                            ...
                            <div class="col-md-6 col-md-offset-4">
                                <label class="control-label mar150">Age :</label><br>
                                    <label><input type="radio" class="custom-radio" name="radioAge[]" id="radio_one" value="35" >&nbsp; Below 35</label>
                                    <label>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary filterable">
                            ...
                            <div class="col-md-4 col-md-offset-4">
                                ...
                                {!! Form::select('professions', $professions, null,['class' => 'form-control', 'id' => 'professions','placeholder'=>'Select Profession']) !!}
                            </div>
                            </div>
                            <div class="panel-body table-responsive">
                        ...
                        <div class="panel panel-primary filterable">
                            ...
                            <div class="row filter">
                                <div class="col-md-4">
                                    ...
                                    <div> <b class="margin_right15">{{$min_id}}</b>
                                        <input id="id_range2" type="text" data-slider-id='id_range' class="slider" data-slider-handle="square" value="" data-slider-min="{{$min_id}}" data-slider-max="{{$max_id}}" data-slider-step="1" data-slider-value="[{{$min_id}},{{$max_id}}]"/> <b class="m-l-15">@if(!empty($max_count)){{$max_id}} @else 10 @endif</b>
                                    </div>
                                </div>

                                <div class="col-md-5">
                                    <label class="control-label mar150">Age :</label><br>
                                    <label><input type="radio" class="custom-radio2" name="radioAge[]" id="radio_one" value="35" >&nbsp; Below 35</label>
                                    <label>
                                    ...
                                    <div class="col-md-3">
                                        <label class="control-label">Profession :</label>
                                        {!! Form::select('professions', $professions, null,['class' => 'form-control', 'id' => 'professions2','placeholder'=>'Select Profession']) !!}
                                    </div>
                            </div>
                            <div class="panel-body table-responsive">
