...
@section('header_styles')
    <!--page level css -->
    <link rel="stylesheet" href="{{ asset('assets/vendors/jstree/css/style.min.css') }}" />
    <link rel="stylesheet"  href="{{ asset('assets/vendors/treeview/css/bootstrap-treeview.min.css') }}" />
    <link rel="stylesheet"  href="{{ asset('assets/css/pages/treeview_jstree.css') }}" />
...
<script type="text/javascript" src="{{ asset('assets/vendors/treeview/js/bootstrap-treeview.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('assets/js/pages/treeview_jstree.js') }}"></script>
