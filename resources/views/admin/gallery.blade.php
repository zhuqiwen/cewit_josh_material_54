                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active gallery-padding" id="tab_1">
                                    <div class="col-md-12">
                                        <div class="col-lg-2 col-md-3 col-xs-6 col-sm-3 gallery-border">
                                            <a class="fancybox-effects-a" href="{{ asset('assets/img/img_holder/gal/1.jpg') }}" title="Click aside to exit popup">
                                        ...
                                        <div class="col-lg-2 col-md-3 col-xs-6 col-sm-3 gallery-border">
                                            <a class="fancybox-effects-b" href="{{ asset('assets/img/img_holder/gal/1.jpg') }}" title="Click aside to exit popup">
                                                <img src="{{ asset('assets/img/img_holder/gal/1.jpg') }}" class="img-responsive gallery-style" alt="Image">
                                            </a>
                                        </div>
                                        <div class="col-lg-2 col-md-3 col-xs-6 col-sm-3 gallery-border">
                                            <a class="fancybox-effects-c" href="{{ asset('assets/img/img_holder/gal/1.jpg') }}" title="Click on popup for exit">
                                                <img src="{{ asset('assets/img/img_holder/gal/1.jpg') }}" class="img-responsive gallery-style" alt="Image">
                                            </a>
                                        </div>
                                        <div class="col-lg-2 col-md-3 col-xs-6 col-sm-3 gallery-border">
                                ...
                                <div class="tab-pane gallery-padding" id="tab_2">
                                    <div class="col-md-12">
                                        <div class="col-lg-2 col-md-2 col-xs-6 col-sm-3 gallery-border">
                                            <a class="fancybox" href="{{ asset('assets/img/img_holder/gal/2.jpg') }}" data-fancybox-group="gallery" title="Image Title 1">
                                                <img src="{{ asset('assets/img/img_holder/gal/2.jpg') }}" class="img-responsive gallery-style" alt="Image">
                                            </a>
                                        </div>
                                        <div class="col-lg-2 col-md-2 col-xs-6 col-sm-3 gallery-border">
                                            <a class="fancybox" href="{{ asset('assets/img/img_holder/gal/2.jpg') }}" data-fancybox-group="gallery" title="Image Title 2">
                                                <img src="{{ asset('assets/img/img_holder/gal/2.jpg') }}" class="img-responsive gallery-style" alt="Image">
                                            </a>
                                        </div>
                                        <div class="col-lg-2 col-md-2 col-xs-6 col-sm-3 gallery-border">
                                            <a class="fancybox" href="{{ asset('assets/img/img_holder/gal/2.jpg') }}" data-fancybox-group="gallery" title="Image Title 3">
                                                <img src="{{ asset('assets/img/img_holder/gal/2.jpg') }}" class="img-responsive gallery-style" alt="Image">
                                            </a>
                                        </div>
                                        <div class="col-lg-2 col-md-2 col-xs-6 col-sm-3 gallery-border">
                                            <a class="fancybox" href="{{ asset('assets/img/img_holder/gal/2.jpg') }}" data-fancybox-group="gallery" title="Image Title 4">
                                                <img src="{{ asset('assets/img/img_holder/gal/2.jpg') }}" class="img-responsive gallery-style" alt="Image">
                                            </a>
                                        </div>
                                        <div class="col-lg-2 col-md-2 col-xs-6 col-sm-3 gallery-border">
                                ...
                                <div class="tab-pane gallery-padding" id="tab_3">
                                    <div class="col-md-12">
                                        <div class="col-lg-2 col-md-2 col-xs-6 col-sm-3 gallery-border">
                                            <a class="fancybox-buttons" data-fancybox-group="button" href="{{ asset('assets/img/img_holder/gal/3.jpg') }}">
                                ...
                                <div class="tab-pane gallery-padding" id="tab_4">
                                    <div class="col-md-12">
                                        <div class="col-lg-2 col-md-2 col-xs-6 col-sm-3 gallery-border">
                                            <a class="fancybox-thumbs" data-fancybox-group="thumb" href="{{ asset('assets/img/img_holder/gal/4.jpg') }}">
