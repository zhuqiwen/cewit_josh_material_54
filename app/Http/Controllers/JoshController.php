...
class JoshController extends Controller {
	...
	*/
	...
	public function secureImage(Request $request)
	{
        ...
        if ($isHuman) {
            echo "The security code entered was correct. <a href='#'  onclick='location.href = document.referrer;return false;'>back</a><br /><br />";
            exit;
        } else {
            echo "The security code entered was incorrect.<br /><br />";
            echo "Please go <a href='#'  onclick='location.href = document.referrer;return false;'>back</a> and try again.";
            exit;
        }
	}
